...
!define MUI_HEADERIMAGE_BITMAP "${__FILEDIR__}\umbral-header.bmp"
...
Section "Instalar Umbral" SecInstall
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "Publisher" "Hersac"
